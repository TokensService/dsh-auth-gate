...
import { enabledCount, isAdmin, loadUsersOr503, readJsonOrRespond, requireSubject, sendCode, sendJson, viewOf, writeUsersOr503, } from "./user-admin-common.js";
...
function selfPasswordOnly(body, username, subject) {
