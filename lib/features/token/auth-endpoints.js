...
import { buildSessionCookie, buildSetCookie } from "../../session/index.js";
/**
...
async function loginAttempt(deps, req, res) {
    ...
    res.setHeader("cache-control", "no-store");
    res.setHeader("set-cookie", buildSessionCookie(deps.cookieName, sessionToken, deps.sessionTtl, deps.cookieSecure));
