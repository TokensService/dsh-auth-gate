	...
	factory: (require) => {
		...
		*/
		...
		const USERS_DICT_EN = {
			...
			"users.error.import_file_not_found": "File not found on the server (only .txt inside imports/ is allowed).",
		...
		*/
		...
		async function listServerImportFiles() {
			try {
		...
		function importUsersServerFile(name) {
		...
		function ServerPicker(props) {
			...
			if (files === null) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				style: CONTROLS_STYLE,
			...
			if (files.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: CONTROLS_STYLE,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: HINT_STYLE$1,
					children: t("users.importNoServerFiles")
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					style: SMALL_BUTTON_STYLE,
					onClick: props.onRefresh,
					children: t("users.importRefresh")
				})]
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: CONTROLS_STYLE,
		...
		*/
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					s.mode === "local" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LocalPicker, {
						...
						onPick: s.pickLocal
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ServerPicker, {
						t,
						files: s.serverFiles,
						selected: s.selected,
		...
		function useImport(onChanged) {
			...
			const [serverFiles, setServerFiles] = (0, react.useState)(null);
			...
			const loadServerFiles = (0, react.useCallback)(async () => {
			...
			(0, react.useEffect)(() => {
				if (mode === "server" && serverFiles === null) loadServerFiles();
			}, [
				mode,
				serverFiles,
				loadServerFiles
			...
			return {
				...
				submit: (0, react.useCallback)(async () => {
					...
					resetOutcome();
					try {
						const result = mode === "local" ? await importUsersText(await readFileText(localFile)) : await importUsersServerFile(selected);
						if (result.ok) {
